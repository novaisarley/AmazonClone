package com.arley.amazonclone.adapter;
...
public class MainProductRecyclerViewAdapter extends RecyclerView.Adapter<MainProductRecyclerViewAdapter.ViewHolder> {
    ...
    public MainProductRecyclerViewAdapter(List<Product1> productList, Context context) {
